...
-- no / yes
  ...
  deck = [
    ...
    ("Go out to the bar", (4,1,0,-12), (-8,-2,-10,12)),
    ("Go to a concert", (2,0,0,-5), (-2,-1,-13,8)),
    ("Study all night", (8,-3,0,0), (-18,7,0,-5)),
    ("Study at the library", (0,-5,0,5), (0,10,0,-5)),
    ("Skip tutorial to get lunch with friends", (0,3,0,-5), (0,-6,-8,3)),
    ("Pick up a shift", (3,3,-5,0), (-8,-3,10,0)),
    ("Pick up a night shift", (3,3,-5,0), (-8,-10,10,0)),
    ("Sell a kidney", (0,0,-5,0), (-3,-6,20,0)),
    ("Go on a date", (4,0,0,-7), (-5,0,-10,14)),
